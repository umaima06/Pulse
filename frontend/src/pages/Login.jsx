...
function Login() {
  ...
  const handleEmailAuth = async () => {
    ...
    if (isRegister && !form.organization) {
      setError(t('register_error'))
      return
    }
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center px-4 relative">
      ...
      <Link to="/" className="text-3xl font-black text-orange-400 mb-10">
        ⚡ PULSE
      </Link>
      ...
      <div className="bg-gray-800 rounded-2xl p-8 w-full max-w-md border border-gray-700">
        ...
        <p className="text-gray-400 text-sm mb-8">
          {isRegister ? t('register_sub') : t('login_sub')}
        </p>
      ...
      <p className="text-gray-500 text-sm mt-6">
        {t('volunteer_prompt')}{' '}
        <Link to="/volunteer" className="text-orange-400 hover:underline">
          {t('volunteer_link')}
        </Link>
      </p>
    </div>
