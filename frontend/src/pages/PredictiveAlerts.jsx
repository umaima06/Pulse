...
function PredictiveAlerts() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-gray-900 flex flex-col items-center justify-center">
      ...
      <p className="text-gray-400">Analyzing historical patterns...</p>
    </div>
  )
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h2 className="text-3xl font-bold">Predictive Alerts</h2>
        </div>
        <p className="text-gray-400 mb-8">AI-predicted crises based on historical patterns — act before they happen</p>

        <div className="flex gap-4 mb-8">
          <div className="bg-red-900 px-4 py-3 rounded-lg">
            <p className="text-red-300 text-xs">HIGH CONFIDENCE</p>
          ...
          <div className="bg-gray-700 px-4 py-3 rounded-lg">
            <p className="text-gray-300 text-xs">TOTAL PREDICTIONS</p>
        ...
        {alerts.length === 0 ? (
          <div className="bg-gray-800 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-500 text-sm mt-1">Predictions generate after enough historical data is collected</p>
          </div>
        ) : (
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <div className="flex gap-4 mt-3">
                      <div>
                        <p className="text-gray-500 text-xs">HISTORICAL INCIDENTS</p>
                        <p className="text-white font-bold">{alert.historical_count}</p>
                      </div>
                      <div>
                        <p className="text-gray-500 text-xs">AVG PEOPLE AFFECTED</p>
