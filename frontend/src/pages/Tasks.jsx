      ...
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        <div className="flex gap-4 mb-8">
          <div className="bg-yellow-900 px-4 py-3 rounded-lg">
            <p className="text-yellow-300 text-xs">{t('pending').toUpperCase()}</p>
          ...
          <div className="bg-blue-900 px-4 py-3 rounded-lg">
            <p className="text-blue-300 text-xs">{t('accepted').toUpperCase()}</p>
          ...
          <div className="bg-green-900 px-4 py-3 rounded-lg">
            <p className="text-green-300 text-xs">{t('done').toUpperCase()}</p>
        ...
        {tasks.length === 0 ? (
          <div className="bg-gray-800 rounded-lg p-8 text-center">
            ...
            <p className="text-gray-500 text-sm mt-1">{t('no_tasks_sub')}</p>
          </div>
        ) : (
          <div className="space-y-3">
            {tasks.map(task => (
              <div key={task.id} className="bg-gray-800 rounded-lg p-5 flex items-center justify-between">
                <div>
                  <p className="text-white font-medium">{task.volunteer_name || t('volunteers_label')}</p>
                  <p className="text-gray-400 text-sm mt-1">{t('cluster_label')}: {task.cluster_id}</p>
